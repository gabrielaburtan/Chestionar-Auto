...
namespace Chestionar
{
    public partial class Form5 : Form
    {
        ...
        SqlConnection sqlCon = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Documents and Settings\C:\Users\burta\Desktop\Chestionar\Chestionarchestionar.mdf;Integrated Security=True;User Instance=True");
        ...
        {
            string query = "SELECT * FROM intrebari WHERE categorie = 'A'";

            SqlConnection sqlCon = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Documents and Settings\Users\burta\Desktop\Chestionar\Chestionarchestionar.mdf;Integrated Security=True;User Instance=True");
